"""Initial schema including work_order_entries

Revision ID: 848e5965bb98
Revises: c02fd17d311a
Create Date: 2025-01-05 11:16:52.492104
...
revision = '848e5965bb98'
down_revision = 'c02fd17d311a'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['material_id'], ['materials.material_id'], ondelete='SET NULL'),
