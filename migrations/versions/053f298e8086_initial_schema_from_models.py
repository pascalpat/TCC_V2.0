...
Revision ID: 053f298e8086
Revises: 
Create Date: 2025-05-21 14:58:10.820250
...
def upgrade():
    ...
    op.create_table('cw_packages',
    sa.Column('project_id', sa.Integer(), nullable=False),
    sa.Column('code', sa.String(length=50), nullable=False),
    sa.Column('name', sa.String(length=255), nullable=False),
    sa.Column('unit', sa.String(length=20), nullable=True),
    sa.ForeignKeyConstraint(['project_id'], ['projects.id'], ),
    sa.PrimaryKeyConstraint('project_id', 'code')
    )
    ...
    sa.Column('maintenance_status', sa.Enum('operational', 'under_maintenance', 'out_of_service', name='equipment_status_enum'), nullable=True),
    ...
    sa.Column('contract_type', sa.Enum('fixed_amount', 'cost_plus_expenses', 'time_and_materials', name='contract_type_enum'), nullable=True),
    ...
    sa.Column('role', sa.Enum('admin', 'manager', 'superintendent', 'foreman', 'worker', name='user_roles'), nullable=True),
    ...
    sa.Column('procurement_group', sa.Enum('direct', 'bulk', 'rental', name='procurement_group_enum'), nullable=True),
    sa.Column('procurement_type', sa.Enum('material', 'equipment', 'worker', 'subcontractor', 'service', name='procurement_type_enum'), nullable=True),
    ...
    sa.Column('is_change_order', sa.Boolean(), nullable=True),
    ...
    sa.Column('activity_code_id', sa.Integer(), nullable=True),
    sa.Column('status', sa.Enum('pending', 'in_progress', 'completed', name='entry_status'), nullable=True),
    sa.Column('date', sa.Date(), nullable=True),
    sa.Column('description', sa.Text(), nullable=True),
    sa.Column('equipment_hours', sa.Float(), nullable=True),
    ...
    op.create_table('work_order_entries',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    ...
    sa.Column('equipement_cost', sa.Float(), nullable=True),
    ...
    op.create_table('entries_daily_notes',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('project_id', sa.Integer(), nullable=False),
    sa.Column('note_datetime', sa.DateTime(), nullable=True),
    sa.Column('date_of_report', sa.Date(), nullable=False),
    sa.Column('status', sa.Enum('pending', 'committed', 'rejected', name='entry_status'), nullable=True),
    ...
    with op.batch_alter_table('entries_daily_notes', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_entries_daily_notes_note_datetime'), ['note_datetime'], unique=False)
    ...
    op.create_table('work_order_entry_attachments',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    ...
    sa.Column('uploaded_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['entry_id'], ['work_order_entries.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('daily_note_attachments',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('daily_note_id', sa.Integer(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['daily_note_id'], ['entries_daily_notes.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('taken_at', sa.DateTime(), nullable=True),
    sa.Column('uploaded_at', sa.DateTime(), nullable=True),
    sa.Column('status', sa.Enum('pending', 'committed', name='record_status'), nullable=True),
    sa.Column('activity_code', sa.String(length=50), nullable=True),
    sa.Column('work_order_id', sa.Integer(), nullable=True),
...
def downgrade():
    ...
    with op.batch_alter_table('entries_daily_notes', schema=None) as batch_op:
        batch_op.drop_index(batch_op.f('ix_entries_daily_notes_note_datetime'))
