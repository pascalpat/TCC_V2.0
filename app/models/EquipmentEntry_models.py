# app/models/EquipmentEntry_models.py
...
class EquipmentEntry(db.Model):
    """
    Represents a daily equipment entry for tracking usage hours, project details, and activity codes.
    """
    __tablename__ = 'entries_equipment'
    ...
    payment_item    = db.relationship('PaymentItem',  back_populates='equipment_entries',foreign_keys=[payment_item_id],lazy='joined')
